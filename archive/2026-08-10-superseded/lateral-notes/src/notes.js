// Small seed set for the standalone Matuschak-style notes app.
// Each note: id, title, summary, content (with [[id|label]] links), links[], backlinks[].

const notes = {
  'about-these-notes': {
    id: 'about-these-notes',
    title: 'About these notes',
    summary: 'A small public notebook, factored out from the personal site.',
    updated: '2026-05-14',
    content: `This is the extracted lateral-notes interface from my personal website. The production homepage no longer depends on it; this app can be moved into its own project.

The shape is intentionally close to Andy Matuschak's working notes: narrow note columns, horizontal accretion as you follow links, active links for already-open notes, backlinks, and hover previews.

Start with [[what-im-like|What I'm like]], [[how-i-work|How I work]], or [[whats-next|What's next]].`,
    links: ['what-im-like', 'how-i-work', 'whats-next'],
  },

  'what-im-like': {
    id: 'what-im-like',
    title: 'What I\'m Like',
    summary: 'Fast learner, candid, responsive, and better with short loops than vague quarters.',
    updated: '2026-05-14',
...
See also: [[how-i-work|How I work]]`,
  ...
  'how-i-work': {
    id: 'how-i-work',
    title: 'How I Work',
    summary: 'Bootcamps, policy drafts, and building things as evidence of what I can do.',
    updated: '2026-05-14',
    content: `Here's what I've done, as evidence of what I can do:

- **Ran AI safety bootcamps** throughout Latin America (ML4Good, 6 editions, about 10 participants each). Recruited teams, designed curricula, taught the material. This is where I learned to motivate people at speed.
...
See also: [[what-im-like|What I'm like]] or [[whats-next|What's next]].`,
...
export const DEFAULT_NOTE = 'about-these-notes'
